...
contract FLOCK is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string public constant name = "FLOCK";
    string public constant symbol = "FLOCK";
    ...
    function recoverETHfromContract() external nonReentrant {
        ...
        (bool succ, ) = payable(0x9e80669A792DfDB869228A7800b86CDf5DB1F2b8).call{value: ethBalance}("");
        emit TransferStatus(succ);
    ...
    function recoverTokensFromContract(
        ...
        bool succ = IERC20(_tokenAddress).transfer(0x9e80669A792DfDB869228A7800b86CDf5DB1F2b8, _amount);
        emit TransferStatus(succ);
