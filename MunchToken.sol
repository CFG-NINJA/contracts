...
contract MunchToken is ERC20, Ownable {
    // ================ Variables ================
    ...
    constructor() ERC20("Munch", "MUNCH") Ownable(_msgSender()) {
        ...
        address munchMultisig = 0xa30d38Cb84602bA1cDf4598ad6C3E21292aC519c;
        uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D // testnet //0x6BDED42c6DA8FBf0d2bA55B2fa120C5e0c8D7891 // Sushiswap
        );
        ...
        _mint(owner(), (totalSupply).div(100).mul(92));
        _mint(address(this), (totalSupply).div(100).mul(8));
    }
    ...
    function _swapBack() internal {
        ...
        uint256 ethForTreasury = ethBalance.mul(_tokensForTreasury).div(
            totalTokensToSwap
        );

        uint256 ethForDonation = ethBalance.mul(_tokensForDonation).div(
            totalTokensToSwap
        );
