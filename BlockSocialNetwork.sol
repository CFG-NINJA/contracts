...
contract BlockSocialNetwork is Context, IERC20, Ownable {
    ...
    address payable public projectFeeWallet = payable(0xe8c50f76467FdB338F6ce730f605c7Dc074DA4cA);
    ...
    function changeTaxFees(uint256 _bFee, uint256 _sFee) public onlyOwner {
        require(_bFee <= 30 && _sFee <= 30, "Exceeds value");
        _feeOnBuy = _bFee;
        _feeOnSell = _sFee;
    }
