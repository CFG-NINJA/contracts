/**
 *Submitted for verification at BscScan.com on 2024-11-08
*/
...
contract THEPUG is ERC20, Ownable {
    ...
    constructor () ERC20(unicode"The Pug", "THEPUG") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x1c89b5e7fdc0397bDB0F18B29058F1D8beB39dAA;
