/**
 *Submitted for verification at BscScan.com on 2025-02-15
*/
...
contract LuBu is ERC20, Ownable {
    ...
    constructor () ERC20(unicode"LuBu", "LUBU") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xe219a1b860C107DA3F2A15f687168B5E79756Dd7;
