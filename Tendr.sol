/**
 *Submitted for verification at basescan.org on 2024-08-20
*/
...
contract Tendr is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Tendr';
    ...
    uint256 private swapThreshold = ( _totalSupply * 169 ) / 100000;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}
    address public reward = 0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913; //usdc;
    ...
    address internal constant development_receiver = 0x41e28B7edAE38146759fbEC32478dE1E3D5b11C4; 
    address internal constant marketing_receiver = 0x92ec568AC32fC65DCC9aE1138D78d50ED3148806;
    address internal constant liquidity_receiver = 0x41e28B7edAE38146759fbEC32478dE1E3D5b11C4;
