...
abstract contract ERC404 is Ownable {
    ...
    function walletOfOwner(address _owner) public view returns (uint256[] memory) {
        ...
        // Primeiro, contamos quantos NFTs o usuário possui
        ...
        // Inicializamos um array para armazenar os IDs dos NFTs do usuário
        uint256[] memory ownedTokenIds = new uint256[](ownerTokenCount);

        uint256 index = 0;
        // Agora, preenchemos o array com os IDs dos NFTs do usuário
        for (uint256 i = 1; i <= minted && index < ownerTokenCount; i++) {
            if (_ownerOf[i] == _owner) {
    ...
    function _mint(address to) internal virtual {
        ...
        mintedBlockNumber[id] = block.number;
