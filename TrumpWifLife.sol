...
contract TrumpWifLife is ERC20, Ownable {
    ...
    constructor () ERC20("TrumpWifLife", "Truwl") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x9D8F7e7432E775C08021C94D52A34a651b9e5C01);
        ...
        feeReceiver = 0x9D8F7e7432E775C08021C94D52A34a651b9e5C01;
        ...
        _mintOnce(owner(), 50e6 * (10 ** decimals()));
