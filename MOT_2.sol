...
contract MOT_1 is ERC20, Ownable, ReentrancyGuard, OAppSender, OAppReceiver {
    ...
    function swapEtherForTokens() public payable nonReentrant {
        uint8 _poolNumber = 0;
    ...
    function enforceMinterRules(
        ...
        require(
            _verifySignature(messageHash, signature, oracle),
            "Invalid signature"
        );
    ...
    function _recoverSigner(
        ...
        return ecrecover(ethSignedMessageHash, v < 27 ? v + 27 : v, r, s);
    }
