...
contract Moriarty is ERC20, Ownable {
    uint256 public Optimization = 171204990598298299;
IPinkAntiBot public pinkAntiBot; //pinkbot
    bool public mintable;
    bool public burnable;
bool public antiBotEnabled;
event antiBotSwitch(bool);
    constructor(
        string memory name_,
        string memory symbol_,
        uint256 supply_,
        ...
        require(msg.value >= 0.07 ether, "invalid value");
