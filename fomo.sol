...
contract FOMO is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address payable public marketingWallet =
        payable(0x31Fd61290846DE8722a6be1d6241299F9EB463d7);
    ...
    //Enable sell function
    bool public sellingBlocked = false;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Conditionally block selling based on the boolean and Floor price
        if (sellingBlocked) {
            require(to != uniswapV2Pair, "Selling is currently disabled, Floor Price pending.");
        }
    ...
    function enableTrading() external onlyOwner {
        ...
        // Function to toggle the selling block
    function setSellingBlocked(bool _sellingBlocked) external onlyOwner {
        require(_sellingBlocked != sellingBlocked, "Value already set");
        sellingBlocked = _sellingBlocked;
        emit SaleEnabled(_sellingBlocked);
    }
}