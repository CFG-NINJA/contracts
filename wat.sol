...
//--- Contract v3 ---//
contract WAT is Context, Ownable, IERC20 {
    ...
    uint256 public constant swapThreshold = _totalSupply / 1_000;
    uint256 public constant buyfee = 40;
    ...
    address payable private marketingAddress =
        payable(0x226C1Aa4bD8c73e69CF84f3c83204221b56Ad535);
    address payable private devWallet =
        payable(0x1DbFC6f609A2e0D5C528cecb1a4Bd6f6a2425565);

    //--- v3 Allocations by Freddy analytixaudit.com ---//
    uint256 private buyAllocation = 38;
    uint256 private sellAllocation = 37;
    uint256 private liquidityAllocation = 25;

    IRouter02 public swapRouter;
    string private constant _name = "Wat";
    string private constant _symbol = "WAT";
    string public constant copyright = "analytixaudit.com";
    ...
    constructor() {
        ...
        require(
            buyAllocation + sellAllocation + liquidityAllocation == 100,
            "Freddy: Must equals to 100%"
        );
                ...
                if (buyAllocation > 0 || sellAllocation > 0)
                    internalSwap(
                        (contractTokenBalance *
                            (buyAllocation + sellAllocation)) / 100
                    );
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 mktAmount = (address(this).balance * 60) / 100;
        uint256 devAmount = (address(this).balance * 40) / 100;

        if (mktAmount > 0)
            (success, ) = marketingAddress.call{value: mktAmount, gas: 35000}(
                ""
            );
        if (devAmount > 0)
            (success, ) = devWallet.call{value: devAmount, gas: 35000}("");
    }
