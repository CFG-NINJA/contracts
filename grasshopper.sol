...
error GGH__InvalidBuyFees();
error GGH__InvalidSellFees();
error GGH__UnableToTransfer();

contract GreenGrassHopper is ERC20, Ownable {
    ...
    ) ERC20("Green Grass Hopper", "GGH") {
        _transferOwnership(0xE84f9240c39F7f0dF5374ce739080AA3101aCd65);
        _mint(owner(), MAX_SUPPLY);

        marketingWallet = payable(0x257f718F13e85BA86e363E4dA6915C31A9D1Ac7f);
        lpWallet = payable(0xfbf8b3b5eb0997167aA7d4271f2D3E1d1351E8dA);
        bbbWallet = payable(0x89E28b9A038238D94BF0f9045BDe88fFE172B465);
    ...
    function setBuyFees(uint lpFee, uint marketingFee) external onlyOwner {
        ...
        if (fullBuyFee > 4) revert GGH__InvalidBuyFees();
    ...
    function setSellFees(
        ...
        if (fullSellFee > 8) revert GGH__InvalidSellFees();
    ...
    function claimLeftoverBNB() external onlyOwner {
        ...
        if (!succ) revert GGH__UnableToTransfer();
    }
