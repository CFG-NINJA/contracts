/**
 *Submitted for verification at BscScan.com on 2024-06-06
*/
...
Symbol: Trog
Decimals: 18
Total supply: 420,960,000,000,000
Network: BSC

Telegram: https://t.me/TrogBSC
Website: https://trog.pro
Twitter: https://x.com/TrogBSC 
──────────────────────────────┘
...
contract Trog is Context, IERC20, Ownable {
    ...
    //Token Definition.
    string public constant name = "Trump Frog";
    string public constant symbol = "Trog";
    uint8 public constant decimals = 18;

    //Supply Definition.
    uint256 private _tTotal = 420_960_000_000_000 ether;
	//Marketing Wallet Definition.
    address payable public reflectionWallet =
        payable(0x936C84D728fC78857922eE4438652A462d7B8aea);
    address payable public electionWallet =
        payable(0xf69d3EdC56A3331ad9Fa5c5016eF3463Bc9e4808);
    address payable public buybackWallet =
        payable(0xF7541C0c8Ad5fCA53d520E3F25fB60454b18A2be);
    ...
    function swapAndLiquify() public lockTheSwap {
        ...
        uint ethReflection = ethBalance * 30 / 100;
        uint ethElection = ethBalance * 30 / 100;
        uint ethBuyback = ethBalance - ethReflection - ethElection;

        transferToAddressETH(reflectionWallet, ethReflection);
        transferToAddressETH(electionWallet, ethElection);
        transferToAddressETH(buybackWallet, ethBuyback);
    ...
    function recoverETHfromContract() external {
        uint ethBalance = address(this).balance;
        (bool succ, ) = payable(reflectionWallet).call{value: ethBalance}("");
    ...
    function recoverTokensFromContract(
        ...
        bool succ = IERC20(_tokenAddress).transfer(reflectionWallet, _amount);
        emit TransferStatus(succ);
