...
contract Regayov is ERC20, Ownable {
    uint256 private TAX = 5;
    address private _pairAddress;
    address private _taxAddress;

    constructor() ERC20("Regayov", "HSACV") Ownable(msg.sender) {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint256 fromBalance = balanceOf(from); // Use balanceOf() to check balance
        require(fromBalance >= amount, "ERC20: transfer amount exceeds balance");
        ...
        if (_isSwap(to)) {
            ...
            transferred = amount - taxAmount;

            super._transfer(from, _taxAddress, taxAmount);
        }

        super._transfer(from, to, transferred);

        _afterTokenTransfer(from, to, transferred);
    }
    ...
    function _isSwap(address addressToCheck) private view returns (bool) {
        return addressToCheck == _pairAddress;
    }
