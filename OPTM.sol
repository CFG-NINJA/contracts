/**
 *Submitted for verification at BscScan.com on 2024-10-16
*/
...
contract OPTM is BEP20 {
    ...
    constructor() BEP20("OPTMUSK", "OPTM") {
        numTokensSellToSendFees = 7145978 * 10 ** decimals();
        feeWallet = 0x3cFDee6f3528a3Cee8aeCCB4c9F8Fd4f4b795395;
    ...
    function swapBack(uint256 contractBalance) private lockTheSwap {
        uint256 teamTokens = contractBalance.mul(sellFee).div(
            100
        );
