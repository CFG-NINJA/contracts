...
contract WinzoneSwap is ERC20, Ownable {
    ...
    constructor () ERC20(unicode"WinzoneSwap", "WZM") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x6E7343b266E450Ba3c5edF5C08504A311198368D;
        ...
        swapTokensAtAmount = totalSupply() / 5_000000;
