...
contract Woof is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string public constant name = "Woof";
    ...
    address payable public marketingWallet =
        payable(0x993f8dF7cba23116cCf1E0D6253ee68c52f871a1);
    ...
    function removePresale(address account) external onlyOwner {
        require(
