...
// File: contract_0x94bF6538b6853008A556FC7766f02b437b7A1997/contracts/interfaces/IWETH.sol
...
// File: contract_0x94bF6538b6853008A556FC7766f02b437b7A1997/contracts/interfaces/IDexFactory.sol
...
// File: contract_0x94bF6538b6853008A556FC7766f02b437b7A1997/contracts/interfaces/IUniswapV2Pair.sol
...
// File: contract_0x94bF6538b6853008A556FC7766f02b437b7A1997/contracts/interfaces/IUniswapV2Router.sol
...
// File: contract_0x94bF6538b6853008A556FC7766f02b437b7A1997/contracts/interfaces/draft.sol
...
// File: contract_0x94bF6538b6853008A556FC7766f02b437b7A1997/contracts/Mandarin.sol
    ...
    ReentrancyGuard
{
    ...
    constructor(
        ...
        uint256 _initialPrice, // 250000000000000000000000(250 BNB)
        uint256 _priceSupplyInterval, // 250000000000000000000(250 BNB)
        uint256 _priceIncreasePercent, // 25(2.5%)
    ...
    function mintFor(address account, uint256 value) external onlyOwner {
        _mint(account, value);
    }
    ...
    // Function to add an address to the bot list
    function _addBot(address account) external onlyOwner {
        require(!bot[account], "Address is already a bot");
        bot[account] = true;
        botsCaught++;
    ...
    function _removeBot(address account) external onlyOwner {
        require(bot[account], "Address is not a bot");
        bot[account] = false;
        botsCaught--;
    ...
    function _mintAndAddLiquidityWithETH(
        ...
        (uint256 res0, uint256 res1, ) = IUniswapV2Pair(lpPair).getReserves();
        ...
        if (res0 > 0 && res1 > 0) {
            if (token0 == address(WETH)) {
                ...
                tokens = _getLiquidityAmount(ethAmount, res1, res0);
            }
        } else {
