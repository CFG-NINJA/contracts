/**
 *Submitted for verification at BscScan.com on 2024-11-12
*/
...
>>> Meme token: Baby Pnut
>>> Ticker: BABYPNUT
>>> Website: https://babypnut.vip
>>> Twitter: https://x.com/babypnutbsc
>>> Community: https://t.me/babypnutbsc
...
contract BABYPNUT is Context, IERC20, Ownable {
    ...
    string private _symbol   = "BABYPNUT";
    ...
    {        
        ...
        marketingWallet = 0xdC236cc6AeCB5fC3a5e431AfF54b8591C4f8f5eE;
        
        swapEnabled = true;
        swapTokensAtAmount = _tTotal / 500;
    ...
    function setBuyFeePercentages(uint256 _taxFeeonBuy, uint256 _liquidityFeeonBuy, uint256 _marketingFeeonBuy) external onlyOwner {
        ...
        require(totalBuyFees + totalSellFees <= 20, "Total fees cannot be greater than 25%");
