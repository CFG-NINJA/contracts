...
contract AUTOFI is ERC20Detailed, Ownable {
    ...
    string public _name = "Auto Defi";
    string public _symbol = "AUTOFI";
    ...
    uint256 public AUTOFIInsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(AUTOFIInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public AUTOFIInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("Auto Defi", "AUTOFI", uint8(DECIMALS)) Ownable() {
...
//Variables have been defined now we move on the rest of the configuration	
        ...
        autoLiquidityReceiver = 0x1862fB9f258F3da94DeD009B2105E99DCa780224; //Wallet 1
        treasuryReceiver = 0xB51552B08694858db147D426945D6446B13492C1; //Wallet 2
        AUTOFIInsuranceFundReceiver = 0x7296F111256fEbB44ca6B63E86257B4A894D9156; //Wallet 3
        firePit = 0x82CabB005542D1E19DC0fbD3214A0f4bEFC1D9f2; //Wallet 4
    ...
    function takeFee(
        ...
        uint256 _AUTOFIInsuranceFundFee = AUTOFIInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _AUTOFIInsuranceFundFee = AUTOFIInsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(AUTOFIInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(AUTOFIInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(AUTOFIInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(AUTOFIInsuranceFundFee).div(
                treasuryFee.add(AUTOFIInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no AUTOFI token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _AUTOFIInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        AUTOFIInsuranceFundReceiver = _AUTOFIInsuranceFundReceiver;
        firePit = _firePit;
    }
