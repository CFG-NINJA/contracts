/**
 *Submitted for verification at BscScan.com on 2024-03-04
*/
...
contract XL is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public initSupply = 500000000e18;
    ...
    constructor() {
        _name = "XL";
        _symbol = "XL";
        _mint(0x938bfF02267D8231f71689a3B4706a4d41811b30, initSupply);

        setWList(0x938bfF02267D8231f71689a3B4706a4d41811b30, true);
